    ...
    def train(self, total_time, learning_rate):
        ...
        while running_time < total_time:
            ...
            if it % 10 == 0:
                ...
                sys.stdout.flush()
                start_time = time.time()
                f = open("/public/home/lcc-dx07/HFM-master/Results/train_stenosis.txt", "a")  # 记录loss
...
if __name__ == "__main__": 
    ...
    # Load Data
    data = scipy.io.loadmat('/public/home/lcc-dx07/HFM-master/Data/Stenosis2D.mat')
    ...
    scipy.io.savemat('/public/home/lcc-dx07/HFM-master/Results/Stenosis2D_shear_results_%s.mat' %(time.strftime('%d_%m_%Y')),
    ...
    scipy.io.savemat('/public/home/lcc-dx07/HFM-master/Results/Stenosis2D_results_%s.mat' %(time.strftime('%d_%m_%Y')),
